...
public class frmMenu extends javax.swing.JFrame {
    ...
    public frmMenu() {
        ...
        try{
         ...
         //Mask para Data
          ...
          txtPesquisarCPFCliente.setColumns(14);
          ...
          //DeafaltEdit nas tabelas
          tableListarCliente1.setDefaultEditor(Object.class, null);
          tableListarFuncionario.setDefaultEditor(Object.class, null);
          tableServico.setDefaultEditor(Object.class, null);
          tableSourcePlaca.setDefaultEditor(Object.class, null);
    ...
    private void initComponents() {
        ...
        bntPesquisarCliente2 = new javax.swing.JButton();
        jLabel16 = new javax.swing.JLabel();
        txtPesquisarCPFCliente = new javax.swing.JFormattedTextField();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(passwordLoginSenhaFuncionario, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
        ...
        jLabel21.setText("Valor Horas Add.");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtValorDiariaOperacional)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel51)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel21)
                            .addComponent(txtValorHorasOperacional, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel23)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel20, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtValorPrimeiraHoraOperacional, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        bntPesquisarCliente2.setText("Pesquisar");
        bntPesquisarCliente2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bntPesquisarCliente2ActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel29Layout.createSequentialGroup()
                        .addGroup(jPanel29Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel29Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtPesquisarCPFCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(bntPesquisarCliente2)))
        ...
        tableListarCliente1.setRowSelectionAllowed(false);
        ...
        txtModeloVeiculoServico.setEditable(false);
        ...
        txtNomeClienteServico.setEditable(false);

        txtPlacaVeiculoServico.setEditable(false);
        ...
        jPanel20Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel20Layout.createSequentialGroup()
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel55)
                    .addComponent(txtValorTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        bntDialogFuncionario.setText("Cadastrar Funcionário");
        ...
        bntDialogClienteVeiculo.setText("Cadastrar Cliente/Veículo");
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtNomeFuncionarioLogado, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void bntSairLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSairLoginActionPerformed
	    ...
	    private void bntLogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntLogarActionPerformed
            ...
            String usuario = txtUsuarioLogin.getText().trim().toUpperCase();
    ...
    private void bntNovo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNovo1ActionPerformed
        ...
        try {
            ...
            this.txtQtdDias1.setText("");
            this.txtQtdHoras1.setText("");
    ...
    private void bntPesquisarCliente1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntPesquisarCliente1ActionPerformed
        ...
        try {
            ...
            if (txtPesquisarPlacaVeiculo.getText().isEmpty()) {
                ...
                veiculo.setPlaca(txtPesquisarPlacaVeiculo.getText().toUpperCase());
    ...
    private void bntEditarServico1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEditarServico1ActionPerformed
        ...
        if (txtNumEntrada.getText().isEmpty()
            ...
            return;
            }else if(horaEntrada_Time.isAfter(limiteHora) && dataEntrada_Time.isEqual(dataSaida_Time)){
            JOptionPane.showMessageDialog(null, "Hora de Entrada inválida ", "Erro de Horário", JOptionPane.ERROR_MESSAGE);
            return;
            }else if(dataEntrada_Time.isAfter(limiteData)){
            JOptionPane.showMessageDialog(null, "Data de Entrada inválida ", "Erro de Data", JOptionPane.ERROR_MESSAGE);
            return;
            }else if(horaSaida_Time.isBefore(horaEntrada_Time) && dataEntrada_Time.isEqual(dataSaida_Time)){
            JOptionPane.showMessageDialog(null, "Hora de Saída inválida ", "Erro de Horário", JOptionPane.ERROR_MESSAGE);
            return;
            }else if(dataSaida_Time.isBefore(dataEntrada_Time)){
            JOptionPane.showMessageDialog(null, "Data de Saída inválida ", "Erro de Data", JOptionPane.ERROR_MESSAGE);
            return;
            }
    ...
    private void bntSalvarFuncionario1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSalvarFuncionario1ActionPerformed
        ...
        try {
            ...
            if(!txtNomeFuncionario.getText().trim().isEmpty()
               || !txtCpfFuncionario1.getText().trim().isEmpty()
               || !txtTelefoneFuncionario.getText().trim().isEmpty()
               || !txtEmailFuncionario.getText().trim().isEmpty()
               || txtSenhaFuncionario.getPassword().length > 0){
                
            funcionario.setNome(txtNomeFuncionario.getText());
            funcionario.setCpf(txtCpfFuncionario1.getText());
            funcionario.setTelefone(txtTelefoneFuncionario.getText());
            funcionario.setEmail(txtEmailFuncionario.getText().toUpperCase());
    ...
    private void bntPesquisarCliente2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntPesquisarCliente2ActionPerformed
        // TODO add your handling code here:
        try {
            ConClientes conCliente = new ConClientes();
            Clientes cliente = conCliente.pesquisar(txtPesquisarCPFCliente.getText());

            if (txtPesquisarCPFCliente.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha o CPF para realizar a pesquisa");
            } else {
                this.codigo1 = cliente.getCodigo();
    ...
    }//GEN-LAST:event_bntPesquisarCliente2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                if (!menu.isVisible()) {
                    menu.dialogLogin.setSize(255, 200);
    ...
    private javax.swing.JButton bntPesquisarCliente2;
    ...
    private javax.swing.JFormattedTextField txtPesquisarCPFCliente;
