...
FOREIGN KEY (CODVAGA) REFERENCES TBVAGA (IDVAGA) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (CODVEICULO) REFERENCES TBVEICULO (IDVEICULO) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (CODFUNCI) REFERENCES TBFUNCIONARIO (IDFUNCI) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=INNODB;
